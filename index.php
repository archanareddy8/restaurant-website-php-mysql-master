				...
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
							Crafted with care, our dishes boast quality ingredients sourced
							 locally for a culinary journey that delights the senses
	                        </p>
	                    </div>
	                </div>
				</div>
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
							Experience excellence with our commitment to quality delivery and service, ensuring every moment is memorable and every need met
	                        </p>
	                    </div>
	                </div>
				</div>
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
							Indulge in culinary perfection with our menu featuring quality food prepared with passion and precision
	                        </p>
	                    </div>
	                </div>
				</div>
            ...
            <div class="row">
                <div class="col-lg-6 sm-padding">
                    <div class="contact-info">
                        ...
                        <p>
						Ignyt -The Beer Station in Kumaraswamy Layout has a wide range of products and / or services to cater to the varied requirements of their customers. The staff at this establishment are courteous and prompt at providing any assistance. They readily answer any queries or questions that you may have. 
                        </p>
                        <h3>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        ...
                        <ul class="opening_time">
                            <li>Monday - Sunday 11:00am - 12:30am</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
