		...
		<form method="post" id="order_food_form" action="order_food.php">
            ...
            <div class="client_details_tab order_food_tab" id="clients_tab">
                ...
                <div>
                    ...
                    <div class="form-group colum-row row">
                        <div class="col-sm-12">
                            <input type="text" name="client_delivery_address" id="client_delivery_address" oninput="document.getElementById('required_delivery_address').style.display = 'none'" class="form-control" placeholder="Table number">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                     <div class="footer_widget">
                        <h3>Headquarters</h3>
                        <p>
                        4th floor, 1767, 14th Main Road, 178/6 14th main road, Kumaraswamy Layout, Bengaluru, Karnataka
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        ...
                        <ul class="opening_time">
                            <li>Monday-Sunday 11:00am - 12:30 am</li>
